...
def get_pd_data(year):
    """Получает данные о вероятности дефолта за указанный год."""
...
pd_function = Function(
    name="get_pd_data",
    description="Получает данные о вероятности дефолта (PD) в разных корзинах просрочки за указанный год (года с 2021 по 2023). Вероятность получается в абсолютных единицах от 0 до 1.",
